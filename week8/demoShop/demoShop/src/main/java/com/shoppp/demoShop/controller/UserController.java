...
public class UserController
{
    ...
    @GetMapping("/user/{id}")
    @ApiOperation(value = "get one user", httpMethod = "GET http://localhost:8080/user", consumes = "returns list of users")
    @ApiResponses(value = {@ApiResponse(code = 200, message = "returns one user")})
